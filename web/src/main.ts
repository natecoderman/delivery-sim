...
const addPirateButton = $("#add-pirate")[0];
...
// Keller: position: [64.0, 290, -210]
// Korean Bistro: [507.0, 290, -181]
// Coffman: [--147, 290 ,-57]
// Anderson Hall: [-722, 290, 40]
// Tate: [-44, 290, -297]
// North of Keller: =x -z
// South of Keller: =x +z
// East of Keller: +x =z
...
addPirateButton.onclick = () => {
  ...
  sendCommand("CreateEntity", {
    type: "pirate",
    name: "Pirate-" + pirateID,
    mesh: "assets/model/pirate.glb",
    position: [randomX, 290, randomZ],
