...
class SimulationModel : public IObserver {
 public:
  ...
  /**
   * @brief Contains all the pirates in the simulation
   */
  std::vector<PorchPirate*> pirates;

  /**
   * @brief Contains all the owners in the simulation
   */
  std::vector<Owner*> owners;

  /**
   * @brief Contains vector of Simluation Model entities
   */
